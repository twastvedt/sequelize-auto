...
function showTablesGeneric(schemaName, views) {
  console.log('showTablesGeneric', schemaName, views);
  var viewClause = views ? " or table_type = 'VIEW'" : "";
  return `SELECT table_name, table_schema
            FROM information_schema.tables
           WHERE (table_type = 'BASE TABLE'${viewClause})
...
exports.mysql = {
  ...
  // showTablesQuery: function(db, schemaName, views) {
  //   return showTablesGeneric(db, views);
  // }
...
exports.postgres = {
   ...
   */
  showTablesQuery: function(db, schemaName, views) {
    return `${showTablesGeneric(schemaName, views)}
